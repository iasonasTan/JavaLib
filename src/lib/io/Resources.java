...
public final class Resources {
    ...
    public static String loadText(String path, Class<?> clazz) {
        try (InputStream inputStream = clazz.getResourceAsStream(path)) {
            ...
            printExceptionInfo("Could not load resource "+path, e);
            return "COULD NOT LOAD RESOURCE";
        }
    }

    /**
     * Prints exception info and given message.
     * Prints given message and exception type, message, cause and stacktrace.
     * Uses {@link System#err} to print errors.
     * @param message Message to print before exception info.
     * @param e exception to print its info (see above list).
     */
    public static void printExceptionInfo(String message, Exception e) {
        ...
        System.err.printf("""
                ...
                UI.stacktraceToString(e.getStackTrace())
        );
    }
